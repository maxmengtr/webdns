...
/*
	API Configuration
*/
$config["api_url"]		= "http://ns.intra.tr:8180/namedmanager";			// Application Install Location
$config["api_server_name"]	= "ns.intra.tr";				// Name of the DNS server (important: part of the authentication process)
$config["api_auth_key"]		= "Webind";					// API authentication key
